...
class SelectedBookScreen extends StatelessWidget {
  ...
  SelectedBookScreen({Key? key, required this.popularBookModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    primary: kMainColor, // Warna garis tepi tombol
    side: BorderSide(color: kMainColor), // Warna garis tepi tombol
  ...
  child: Text(
    ...
    style: GoogleFonts.openSans(
      ...
      color: kMainColor, // Warna teks tombol
    ),
  ),
),
//     decoration: BoxDecoration(
//   borderRadius: BorderRadius.circular(5),
//   border: Border.all(color: kMainColor), // Garis tepi
// ),
    ...
    size: 30,
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          width: 160,
                          height: 220,
                          child: Image.asset(popularBookModel.image),
